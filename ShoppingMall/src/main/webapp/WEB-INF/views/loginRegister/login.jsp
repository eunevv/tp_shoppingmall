					...
					<div id="article">
						...
						<main class="form-signin w-100 m-auto">
							<form method="post" id="login_form" name="login_form">
								Log in <br>
								<br>
								<br> <input type="radio" name="loigntype" value="user">회원
								&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="loigntype"
									value="admin">관리자 <br>
								<br>
								<div>
								...
								<table style="display: inline-block; margin-top: 10px;">
									<form>
										<tr height="30">
											<td colspan="2" align="center"><a id="kakao-login-btn"></a>
												<!--<div id="result"></div> -->
											</td>
										</tr>
									</form>
...
<script>
	...
	$(".login_button").click(
			function() {
				...
				if ((login_form.loigntype[0].checked == false)
						&& (login_form.loigntype[1].checked == false)) {
