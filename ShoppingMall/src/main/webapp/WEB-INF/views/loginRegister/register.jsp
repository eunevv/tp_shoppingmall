...
===========================================================================================-->
							...
							<table align="center" width="600px">
								<form method="post" action="registerOk" name="signform" id="signform" onsubmit="return mySubmit()">
									...
									<tr height="50px">
										<td class="menu">암호</td>
										<td style="color: gray; font-size: small; text-align: right;">
											(영문 대소문자/숫자/특수문자 3가지 이상 조합, 8~16자)
										</td>
									</tr>
									<tr height="50px">
										<td colspan="2">
									...
									<tr height="50px">
										<td colspan="2"><input type="password" size="20" name="re_pwd" id="re_pwd">
										</td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: left;">
									...
									<tr height="50px">
										<td colspan="2"><input type="text" size="20" name="name"
											id="name"></td>
									</tr>
									<tr height="50px">
										<td class="menu">번호</td>
									...
									<tr>
										<td colspan="2" style="text-align: left;">
											...
											<span class="hp_already">전화번호가 이미 존재합니다.</span>
										</td>
									</tr>
									<tr height="50px">
										<td class="menu">메일</td>
	...
	===========================================================================================-->
							...
							<div class="checkbox_group" align="center">
								<div>
									<b>전체 동의</b> <br>
									<br> <input type="checkbox" id="check_all"> <label
										for="check_all">이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두
										동의합니다.</label>
								</div>
								<br>
								<div>
									<b>[필수]개인정보 처리방침 동의</b> <br>
									<br>
									<textarea rows=6 cols="70" readonly><%@ include
											file="./h1.jsp"%></textarea>
									<br> 이용약관에 동의하십니까? <input type="checkbox" id="check_1"
										class="normal"> <label for="check_1">동의함</label><br>
								</div>
								<br>
								<div>
									<b>[필수]서비스 이용약관 동의</b> <br>
									<br>
									<textarea rows=6 cols="70" readonly><%@ include
											file="./h2.jsp"%></textarea>
									<br> 이용약관에 동의하십니까? <input type="checkbox" id="check_2"
										class="normal"> <label for="check_2">동의함</label> <br>
								</div>
								<br>
								<div>
									<b>[선택]마케팅 수신 동의</b> <br>
									<br>
									<textarea rows=6 cols="70" readonly><%@ include
											file="./h3.jsp"%></textarea>
									<br> SMS 수신을 동의하십니까? <input type="checkbox" id="check_3"
										name="sms" class="normal" value="N"> <label
										for="check_3">동의함</label> <br> 이메일 수신을 동의하십니까? <input
										type="checkbox" id="check_4" name="emails" class="normal"
										value="N"> <label for="check_4">동의함</label>
								</div>
							</div>
							<!-- =============================================================================================    -->
...
<script>
	...
	$(".checkbox_group").on(
			...
			function() {
				...
				$(this).parents(".checkbox_group").find('.normal').prop(
						"checked", isChecked).val(isChecked ? 'Y' : 'N');
			});
	...
	function phoneNumber(input) {
		...
		if (hpNumber.length === 3) {
			...
			hpNumber = hpNumber.slice(0, 3) + '-' + hpNumber.slice(3, 6) + '-'
					+ hpNumber.slice(6);
		} else if (hpNumber.length >= 11) {
			hpNumber = hpNumber.slice(0, 3) + '-' + hpNumber.slice(3, 7) + '-'
					+ hpNumber.slice(7);
		}
		// 변경된 번호를 입력 필드에 반영
