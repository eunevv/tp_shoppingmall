					...
					<div id="article" style="height: auto;">
						...
						<div>
							<p style="color: black;">Review</p>
					 		<p style="font-size: small">상품후기</p>
						</div>
<!-- 				@@@여기서부터 -->
								...
								<tr>
									...
									<td style="padding: 10px;">
					        			<div style="margin-left: 10px;">
											<div id="proname"><b>${rev_writeView.proname}</b></div>
					...
					<!-- 			추가 -->
							<form method="post" action="rev_write" id="writeForm">
									<input type="hidden" name="procode" id="procode" value="${rev_writeView.procode}">
									<input type="hidden" name="cartcode" id="cartcode" value="${rev_writeView.cartcode}">
									<input type="hidden" name="id" id="id" value="${rev_writeView.id}">
								<tr style="height: 50px;">
									<td style="width: 100px;">Subject</td>
									<td><input type="text" name="revtitle" size="50" id="revtitle"></td>
								</tr>
								<tr>
									<td colspan="2" style="padding: 20px;">
										<textarea rows="10" cols="100" name="revcont" size="500" id="revcont"></textarea>
									</td>
								</tr>
							</form>
								...
								<tr>
									<td colspan="2">
										<div style="margin-top: 15px;">
											<input type="button" value="Write List" class="list" onclick="location.href='rev_list'">
										</div>
										<div>
