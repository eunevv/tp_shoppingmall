          ...
          <aside id="aisdeLeft">
            ...
            <div class="category" style="position: absolute; top: 70px;">
              <ul style="width: 200px;">
                 <li><a href="/ShoppingMall/notice/list_admin">공지사항</a></li>
                <li><a href="/ShoppingMall/Qna_list_admin">문의 관리</a></li>
                <li><a href="/ShoppingMall/rev_list_admin">리뷰 관리</a></li>
...
<!-- 						@@@본문추가 구나현 -->
						<div>
					 		...
					 		<p style="font-size: small">상품문의</p>
						</div>
						<table>
	    					<tr>
	    					...
	    					<tr>
	    						<form method="post" class="qnacontentview" action="Qna_contentView">
	     						...
	     						<td>
	        						<a href="Qna_contentView_adimn?qnacode=${dto.qnacode}" class="move_link">
	          							${dto.qnatitle}
	        						</a>
