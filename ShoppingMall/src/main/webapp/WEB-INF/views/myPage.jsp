			...
			<section id="section" style="width: 600px;">
				<article>
					<div id="article">
						...
						<div style="text-align: center; margin-bottom: 150px;">My
							Page</div>


						<ul style="margin-bottom: 100px;">
							<li class="box"><a href="userOrder/userOrderList"> Order
									<br> <span> 주문조회 </span>
							</a></li>
							<li class="box"><a
								href="mypage/myPage_view?id=${id}&pwd=${pwd}"> Profile <br>
									<span> 회원정보 </span>
							</a></li>
							<li class="box"><a href="#"> Wishlist <br> <span>
										찜 </span>
							</a></li>
							<li class="box"><a href="#"> Point <br> <span>
										적립금 </span>
							</a></li>
							<li class="box"><a href="#"> Coupon <br> <span>
										쿠폰 </span>
							</a></li>
							<li class="box"><a href="#"> Borad <br> <span>
										게시물 관리 </span>
							</a></li>
							<li class="box"><a href="#"> Address <br> <span>
										배송지 관리 </span>
							</a></li>
						</ul>
						...
						<div>
							<div class="title">
								<strong>나의 주문 처리 현황</strong> (최근 3개월 이내)
							</div>

							<div class="state">

								<ul
									style="text-align: center; padding: 20px; margin-bottom: 30px;">
									<li class="order"><span>입금전</span> <br> 임시 (0)</li>
									<li class="order"><span>배송준비중</span> <br> 임시 (0)</li>
									<li class="order"><span>배송중</span> <br> 임시 (0)</li>
									<li class="order" style="border-right: none;"><span>배송완료</span>
										<br> 임시 (0)</li>
								</ul>
