						...
						<main class="form-signin w-100 m-auto">
							...
							<div class="w3-content w3-container w3-margin-top">
								<div class="w3-container w3-card-4">
									...
									<div class="w3-center w3-large w3-margin-top">Search
										Password</div>
									<br>
									<br>
									<div align="center">
										...
										<table>
											<tr height="50px">
												<td width="100px" align="left">ID<td>
												<td><input class="w3-input" type="text" id="id"
											...
											<tr height="50px">
												<td width="100px" align="left">Email<td>
												<td><input class="w3-input" type="text" id="email"
										...
										<table>
											<tr>
												<td height="60px">
													<button type="button" id='find_pwd'
														onclick="findPwd_click()"
